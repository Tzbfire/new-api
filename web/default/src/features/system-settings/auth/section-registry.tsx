    ...
    build: (settings: AuthSettings) => (
      <OAuthSection
        defaultValues={{
          ...
          YaohuoOAuthEnabled: settings.YaohuoOAuthEnabled,
          YaohuoClientId: settings.YaohuoClientId,
          YaohuoClientSecret: settings.YaohuoClientSecret,
          QuotaForYaohuoRegister: settings.QuotaForYaohuoRegister,
          QuotaForYaohuoBind: settings.QuotaForYaohuoBind,
