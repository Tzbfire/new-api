...
type ChannelSettings struct {
	...
	// SupportedImageSizeTiers limits image-generation channel routing by resolution tier ("1K"/"2K"/"4K").
...
type ChannelOtherSettings struct {
	...
	// ImageGenerationInjection overrides the global Responses image_generation tool injection policy for this channel.
	// nil follows global policy; true forces injection; false disables injection.
